...
from rnn_wdcnn_model import generate_model

from clr_callback import CyclicLR
from cwru_data_loader import CWRUBearingData
...
# data parameters
parser.add_argument('-data_path',type=str, help='C:\\Users\\Dilan\\Desktop\\FYP\\rolling-element-bearing-fault-detection-main\\data')
...
for l in target:
    ...
    if plot:    
        import visualisation_utils as myvis
